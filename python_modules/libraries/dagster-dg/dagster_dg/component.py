...
class RemoteLibraryObjectRegistry:
    ...
    def from_dg_context(
        ...
        discovered under the "dg.library" entry point group in the target environment. If
        `extra_modules` is provided, these will also be searched for library objects.
        """
    ...
    def __repr__(self) -> str:
        return f"<RemoteComponentRegistry {list(self._objects.keys())}>"
